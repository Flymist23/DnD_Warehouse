...
# Open the CSV  
f = open( '\\DnD_Warehouse\\DnD_DataBuffers\\buffer.csv', 'r' )  
...
# Save the JSON  
f = open( '\\DnD_Warehouse\\DnD_DataBuffers\\dnd_players.json', 'w+')  
f.write(out)  
f.close()
JsonConvertIntoLineDeliniated("\\DnD_Warehouse\\DnD_DataBuffers\\dnd_players","dnd-players" )
